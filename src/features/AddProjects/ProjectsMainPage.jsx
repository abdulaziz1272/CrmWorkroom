...
import { Menu, AlignStartHorizontal, AlignStartVertical, Funnel } from "lucide-react";
    ...
    <div className='project-main-page'>
      <div className="main-page-left">
        <div className="project-left-top">
          <img src={selectedLogo} alt="selected-logo" />
          <ul>
            {menu.map((item, index) => (
              <li key={index}>
        ...
        <div className="project-left-bottom">
          <div className='supprt-btn'>
            <div>
              <img src={supportImage} alt="support image" />
              <button><i className="fa-regular fa-comment"></i> Support</button>
            </div>
          </div>
      ...
      <div className="main-page-right">
        <div className="right-header">
          ...
          <div className="header-right">
            <div className="ring" onClick={handleClick}>
              <i ref={iconRef} className="fa-regular fa-bell"></i>
            </div>
            <div className='user'>
        ...
        <div className="right-title">
          <p onClick={MoveToAdd}><i className="fa-solid fa-arrow-left"></i><span>Back to Projects</span></p>
          <div className='title-btn'>
            <h2>{nameValue}</h2>
            <button onClick={() => setShow(!show)}><span>+</span><span>Add Task</span></button>
          </div>
        </div>
        <div className="right-content">
          <div className="right-content_left">
            <div className='content-left-first'>
              ...
              <div onClick={MoveToAdd}><i className="fa-regular fa-pen-to-square"></i></div>
            </div>
          ...
          <div className="right-content_right">
            <div className="right-content_top">
              ...
              <ul>
                <li><Menu /></li>
                <li><AlignStartHorizontal /></li>
                <li><AlignStartVertical /></li>
              </ul>
              <div className='filter'><Funnel /></div>
            </div>
            ...
            <div className="right-content-noProject" style={noProjectBar}>
              ...
              <p>There are no tasks in this project yet
                Let's add them</p>
              <button onClick={() => setShow(!show)}><span>+</span><span>Add Task</span></button>
            </div>
            ...
            <div className="right-content-project">
              <ul className='tasks-ul' style={{ display: tasks.length > 0 ? "flex" : "none" }}>
                {tasks.map((task) => (
                  <li key={task.id} className='task-card'>
                    ...
                    <ul className='task-card-details'>
                      ...
                      <li>
                        <span>Priority</span>
                        <h3 className={task.taskPriority}><i class="fa-solid fa-arrow-up"></i><span>{task.taskPriority}</span></h3>
                      </li>
      ...
      {/* Add project shadow */}
      <div className="add-task-shadow" style={{ display: show ? "flex" : "none" }} onClick={() => setShow(!show)}></div>
      ...
      <div className="add-task-bar" style={{ display: show ? "flex" : "none" }}>
        ...
        <div className='task-name col'>
          ...
          <input type="text" id='TaskName' placeholder='Task Name' onChange={(e) => setTaskName(e.target.value)} value={taskName} />
        </div>

        <div className='task-group col'>
          <label htmlFor="TaskGroup">Task Group</label>
          <div className='task-select'>
            <select name="" id="TaskGroup" onChange={(e) => setTaskGroup(e.target.value)} value={taskGroup}>
        ...
        <div className='task-date'>
          <div className='col'>
            ...
            <div>
              <input type="text" placeholder='Select Duration' id='Estimate' onChange={(e) => setTaskDuration(e.target.value)} value={taskDuration} />
          ...
          <div className='col'>
            ...
            <div>
              <input type="text" placeholder='Select Date' id='Dead-line' onChange={(e) => setTaskDead(e.target.value)} value={taskDead} />
        ...
        <div className='task-priority col'>
          ...
          <div className='task-select-div'>
            <select name="" id="Task-priority" onChange={(e) => setTaskPriority(e.target.value)} value={taskPriority}>
        ...
        <div className='task-assignee col'>
          ...
          <div className='task-select-div'>
            <select name="" id="Assignees" onChange={(e) => setTaskAssignee(e.target.value)} value={taskAssignee}>
        ...
        <div className='task-description col'>
          ...
          <textarea name="" id="Description-add" placeholder='Add some description of the task' onChange={(e) => setTaskDescript(e.target.value)} value={taskDescript}></textarea>
        </div>

        <div className='task-footer'>
          <ul>
            <li><img src={script1} alt="script2.1" /></li>
            <li><img src={script2} alt="script2.2" /></li>
          </ul>
          <button
            onClick={() => {
              addTask();
