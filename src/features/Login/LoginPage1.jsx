    ...
    <div className='login-page'>
        ...
        <div className="main-top">
          <div className='main-container'>
              ...
              <div className='tel-div'>
                ...
                <div className='tel-bar'>
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      const entered = e.target.value.replace(countryCode, "").trim();
            ...
            <div className="main-notice">
              ...
              <p>
                SMS was sent to your number {countryCode} {phoneNumber || "xxx-xxx-xxx"}
                <br />It will be valid for 01:25 mins
              </p>
            </div>
      ...
      <div className="message" style={{ right: `${smsRight}px` }}>
        <div className='message-top'>
          ...
          <button className='delete-btn' onClick={removeMessage}>x</button>
        </div>
        <div className='message-bottom'>
          <p>We have received your request. Please do not share this code with others.</p>
          <p>Your cade is: <span className='varification-code'>{smsCode}</span></p>
        </div>
      </div>
    </div>
  );
