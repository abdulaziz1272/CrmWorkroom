            ...
            <div className="Login">
                <div className="left">
                    <div className="logo__img">
                        <img src={Logo_img} alt="img" loading='lazy' width={50} height={50} />
                        <p>Woorkroom</p>
                    </div>
                    <h2>Your place to work <br /> Plan. Create. Control.</h2>
                    <img src={login_img} alt="img" loading='lazy' width={505} height={340} />
                </div>
                ...
                <div className="right">
                    ...
                    <p onClick={Move} className='forget_password'>Don’t have an account?</p>
                </div>
